  ...
  <div className="w-full md:w-1/2 flex justify-center items-center p-5 md:p-10">
    <div className="w-full max-w-xl space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        ...
        <div className="flex items-end" onClick={FetchHotels}>
          <button className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-xl py-2 text-sm font-semibold transition duration-200 shadow hover:shadow-lg">
            🔍 Search
          </button>
        </div>
      </div>
