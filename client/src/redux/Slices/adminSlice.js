...
export const loadAdmin = createAsyncThunk("admin/loadAdmin", async (_, { rejectWithValue }) => {
    try {
...
// Fetch all users (Admin Access Only)
export const getAllHosts = createAsyncThunk("admin/getAllHosts", async (_, { rejectWithValue }) => {
    try {
