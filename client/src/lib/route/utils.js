...
export const decodePolylinePoints = (encoded) => {
    if (!encoded)
        return [];
    try {
...
export const buildGoogleMapsDeepLink = (lat, lng) => `https://www.google.com/maps/dir/?api=1&destination=${lat},${lng}`;
export const createBoundsFromLegs = (legs, timeline) => {
    const points = [];
    legs.forEach((leg) => {
